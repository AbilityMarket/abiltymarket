...
import com.example.model.GoogleOAuthRequest;
import com.example.model.GoogleOAuthResponse;
...
public class GoogleLoginController {
    ...
    final static String clientId = "175347996726-be8037dqnukl23ddkjd89mh263oqbglf.apps.googleusercontent.com";
    final static String clientSecret = "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";
	...
	public String googleAuth(Model model, @RequestParam(value = "code") String authCode)
		...
		GoogleOAuthRequest googleOAuthRequestParam = GoogleOAuthRequest
				...
				.code(authCode)
				.redirectUri("http://localhost:9090/api/login/google/auth")
