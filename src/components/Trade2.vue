			...
			<div class="main">
				<div class="main_left">
					...
					<div class="main_left-1">
						<div class="tab_buy" :class="{tab:state.istab1}" @click="handleTap('buy')"><p>도와주세요</p></div>
						<div class="tab_sell" :class="{tab:state.istab2}" @click="handleTap('sell')"><p>도와줄게요</p></div>
					</div>
					...
					<div class="main_left-3">
						<div class="box2">
							<div class="box">
							<select @change="handleOption($event)" name="" id="" class="main_left-3-select">
							...
							<div class="box">
							<select @change="handleoption2($event)" ref="select" name="" id="" class="main_left-3-select">
					...
					<!-- 검색 버튼 -->
					<div class="main_left-4" @click="clickSearch">
						검색
					</div>
					...
					<div class="main_left-5">
						...
						<img v-if="state.selectcategory!==''" :src="state.close" @click="handleClose" />
					</div>
				</div>
			<div class="main_right">
			</div>
			</div>
			<!-- <boardcomp v-if="state.boardComp" :selectcate=state.selectcategory 
			:selectname=state.selectcategoryname></boardcomp> -->
			<boardcomp v-if="state.boardComp"></boardcomp>
		</section>
...
export default {
	...
	setup () {
		...
		const clickSearch = ()=>{
			...
			store.commit("setSelectcategoryname", state.selectcategoryname)
			store.commit("setSelectcategory", state.selectcategory)
		}
